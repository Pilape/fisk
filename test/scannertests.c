...
void TestScanner(CuTest* tc) {
    ...
    test_token_t expected[] = {
        ...
        {.type = 0, .line = 9, .lexeme = "{"},
        {.type = 0, .line = 9, .lexeme = "square"},
        {.type = 0, .line = 9, .lexeme = "dup"},
        {.type = 0, .line = 9, .lexeme = "*"},
        {.type = 0, .line = 9, .lexeme = "}"},

        {.type = 0, .line = 12, .lexeme = "#5"},
        {.type = 0, .line = 12, .lexeme = "#25"},
        {.type = 0, .line = 12, .lexeme = "#1234567890"},

        {.type = 0, .line = 15, .lexeme = "{"},
        {.type = 0, .line = 15, .lexeme = "function"},
        {.type = 0, .line = 15, .lexeme = "}"},
        {.type = 0, .line = 15, .lexeme = "{"},
        {.type = 0, .line = 15, .lexeme = "function"},
        {.type = 0, .line = 15, .lexeme = "}"},
        ...
        {.type = 0, .line = 16, .lexeme = "quotation"},
        {.type = 0, .line = 16, .lexeme = "]"},
        {.type = 0, .line = 16, .lexeme = "["},
        {.type = 0, .line = 16, .lexeme = "quotation"},
        {.type = 0, .line = 16, .lexeme = "]"},
